...
import org.patriques.output.search.QueryResult;
...
public class TimeSeries {
    ...
    public QueryResultData query(String query) {
        String json = apiConnector.getRequest(new Keywords(query), Function.SYMBOL_SEARCH);
        return QueryResult.from(json);
    }
