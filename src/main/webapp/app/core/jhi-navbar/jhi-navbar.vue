<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="bg-primary">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">acep</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/portfolio">
                        ...
                        <span v-text="$t('global.menu.entities.portfolio')">Portfolio</span>
                    </b-dropdown-item>
          <b-dropdown-item to="/portfolio-entry">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.portfolioEntry')">Portfolio Entry</span>
                    </b-dropdown-item>
          <b-dropdown-item to="/asset">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.asset')">Asset</span>
                    </b-dropdown-item>
