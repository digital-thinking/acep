...
import de.ixeption.acep.service.mapper.UserMapper;
...
class UserResourceIT {
     ...
     *
     * @see de.ixeption.acep.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(Role.ROLE_USER.name()));
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(Role.ROLE_USER.name()));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(Role.ROLE_USER.name());
    }
    ...
    void testUserToUserDTO() {
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(Role.ROLE_USER.name());
    ...
    void testAuthorityEquals() {
        ...
        authorityB.setName(Role.ROLE_ADMIN.name());
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityA.setName(Role.ROLE_USER.name());
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(Role.ROLE_USER.name());
