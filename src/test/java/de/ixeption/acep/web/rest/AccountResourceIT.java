...
import de.ixeption.acep.config.Constants;
import de.ixeption.acep.domain.PersistentToken;
import de.ixeption.acep.domain.User;
import de.ixeption.acep.repository.AuthorityRepository;
...
import de.ixeption.acep.service.dto.PasswordChangeDTO;
import de.ixeption.acep.web.rest.vm.KeyAndPasswordVM;
import de.ixeption.acep.web.rest.vm.ManagedUserVM;
...
import static de.ixeption.acep.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(Role.ROLE_ADMIN.name()));
    }
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(Role.ROLE_USER.name()));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(Role.ROLE_USER.name()));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(Role.ROLE_USER.name()));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(Role.ROLE_ADMIN.name()));
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(Role.ROLE_USER.name()).get());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(Role.ROLE_ADMIN.name()));
